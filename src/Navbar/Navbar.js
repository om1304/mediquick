        ...
        <nav className="bg-white shadow-sm">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20"> {/* Increased height */}
                    ...
                    <div className="flex-grow px-4 lg:ml-6">
                        <div className="relative max-w-lg w-full">
                            <input
                                id="search"
                                name="search"
                                className="block w-full pl-4 pr-12 py-3 border border-gray-300 rounded-md bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 sm:text-lg" // Increased padding and font size
                    ...
                    <div className="hidden sm:flex items-center space-x-6"> {/* Increased spacing */}
                        <Link onClick={openModal} className="text-gray-700 hover:text-green-500 px-4 py-2 rounded-md text-lg font-medium"> {/* Increased font size */}
                            Login
                        </Link>
                    ...
                    <div className="flex sm:hidden">
                        ...
                        >
                            <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> {/* Increased size */}
